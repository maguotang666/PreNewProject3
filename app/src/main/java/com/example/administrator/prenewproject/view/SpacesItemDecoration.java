...
//    }
     ...
     */
    public SpacesItemDecoration(Context context, int orientation, boolean
            isShowBottomDivider, int bottNum) {
        mBottNum=bottNum;
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        final int lastPosition = state.getItemCount() - mBottNum;
